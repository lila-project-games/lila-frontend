...
const getStudents = async () => {
    try {
        ...
        console.error(error);
        throw new Error("Error al obtener alumnado");
    }
};
...
const deleteStudent = async (id) => {
    try {
        ...
        console.error(error);
        throw new Error("Error al intentar eliminar alumno");
    }
}
                ...
                <div class="table-wrapper">
                    ...
                    <div>
                        <div v-if="isError" class="error-message">
                            Ha ocurrido un error al cargar el alumnado, error: {{ errorMessage }}...
                        </div>
